  ...
  return (
    <div className="mesh-bg flex min-h-screen items-center justify-center bg-surface px-4 py-12">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-40 right-1/3 h-[400px] w-[400px] rounded-full bg-cyber-500/8 blur-[100px]" />
        <div className="absolute -bottom-40 left-1/3 h-[300px] w-[300px] rounded-full bg-primary-600/8 blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in-up">
        ...
        <div className="glass-card glow-border p-8">
          <div className="mb-6">
            <h2 className="text-xl font-bold text-white">Konto erstellen</h2>
            <p className="mt-1 text-sm text-gray-400">Werde Teil des MegaMesh-Netzwerks</p>
          </div>
